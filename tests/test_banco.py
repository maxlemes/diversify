...
def test_inserir_perfil(setup_banco):
    ...
    assert perfil['nome'] == "WEG S.A.", f"Esperado 'WEG S.A.', mas obtido {perfil['nome']}"
...
def test_inserir_financas(setup_banco):
    ...
    assert dados_financeiros[2] == -349391.6232885078, f"Esperado -349391.6232885078, mas obtido {dados_financeiros[0][2]}"
...
def test_atualizar_financas(setup_banco):
    ...
    assert dados_financeiros[2] == 123456, f"Esperado 123456, mas obtido {dados_financeiros[0][2]}"
