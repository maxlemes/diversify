...
class GerenciadorBanco:
    def __init__(self, caminho_banco="dados/banco_de_dados.db"):  # observe o endereço e nome do banco de dados
    ...
    def criar_conexao(self):
        ...
        try:
            self.conexao = sqlite3.connect(self.caminho_banco)  # Armazena a conexão em self.conexao
            logging.info(f"Conexão com o banco '{self.caminho_banco}' estabelecida com sucesso.")
    ...
    def criar_tabelas(self):
        ...
        try:
            ...
            # Tabelas 'dre', 'bp', 'fc', 'stats', 'divs', 'ests'
            tabelas = ['dre', 'bp', 'fc', 'stats', 'divs', 'ests']
    ...
    def fechar_conexao(self):
        ...
        try:
            if self.conexao:
                self.conexao.close()
                logging.info(f"Conexão com o banco '{self.caminho_banco}' fechada com sucesso.")
                print(f"Conexão com o banco '{self.caminho_banco}' fechada com sucesso.")
        except sqlite3.Error as erro:
