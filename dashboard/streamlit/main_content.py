...
def show_main_content(investimentos, aporte, distribuicao):
   ...
   """,
    ...
    )  # Usa a paleta padrão do Plotly para gráficos qualitativos
    ...
    with col1:
        ...
        st.markdown(
            "<h3 style='text-align: center;'>Distribuição Atual</h3>",
            unsafe_allow_html=True,
        )
    ...
    st.markdown(
        "<h3 style='text-align: center;'>Distribuição Atual vs Distribuição Desejada</h3>",
        unsafe_allow_html=True,
    )
